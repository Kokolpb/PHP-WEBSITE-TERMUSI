...
$intRows = 10;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo  where id_newsdir='3' or id_newsdir='4' or id_newsdir='5'  and dele=1";   
...
$strSQL = "select * from newsinfo  where id_newsdir='3' or id_newsdir='4' or id_newsdir='5'  and dele=1  order by id_newsinfo desc" ;
...
<table width="975" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>
        <td align="right" bgcolor="#FFFFFF"><a href="/" class="link_navi">首页</a> > <a href="#" class="link_navi">新闻动态</a></td>
      </tr>
      <tr>
