...
$intRows = 10;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo  where id_newsdir='7' and dele=1";   
...
$strSQL = "select * from newsinfo  where id_newsdir='7' and dele=1  order by id_newsinfo desc" ;
      ...
      <tr>
       ...
       <?php for($i=0;$i<sizeof($arrnews);$i++){?> 
        <tr>
          ...
          <td width="557" align="left" valign="middle" ><a href="/hr/newspage.php?id=<?php echo $arrnews[$i][id_newsdir];?>&newsid=<?php echo $arrnews[$i][id_newsinfo];?>" class="link_navi"><?php echo cutstr($arrnews[$i][title],150,1);?></a></td>
